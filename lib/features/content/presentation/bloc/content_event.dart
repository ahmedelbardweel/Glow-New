...
class ContentEvent with _$ContentEvent {
  const factory ContentEvent.getWorlds({@Default(false) bool forceRefresh}) = _GetWorlds;
  ...
  const factory ContentEvent.getMissions(String worldId, {@Default(false) bool forceRefresh}) = _GetMissions;
  ...
  const factory ContentEvent.getStories(String missionId, {@Default(false) bool forceRefresh}) = _GetStories;
  ...
  const factory ContentEvent.getQuestions(String missionId, {@Default(false) bool forceRefresh}) = _GetQuestions;
